#3 main things to back up - Micro backup for higher frequency backup (small snapshot for the most vital things -> more restrictive on allowed files, but can be run more often)
